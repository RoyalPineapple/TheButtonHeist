...
final class HeistPlaybackTests: XCTestCase {
    ...
    func testToRequestDictionary() {
        ...
        XCTAssertEqual(dictionary["command"] as? String, "swipe")
        XCTAssertEqual(dictionary["label"] as? String, "List")
        XCTAssertEqual(dictionary["traits"] as? [String], ["staticText"])
        XCTAssertEqual(dictionary["direction"] as? String, "up")
        XCTAssertEqual(dictionary["duration"] as? Double, 0.5)
        // No _recorded in the request dictionary
        XCTAssertNil(dictionary["_recorded"])
    }
    ...
    func testToRequestDictionaryNoTarget() {
        ...
        XCTAssertEqual(dictionary["command"] as? String, "dismiss_keyboard")
        XCTAssertNil(dictionary["label"])
