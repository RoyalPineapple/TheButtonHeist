...
extension TheFence {
    ...
    func decodeDrawPathTarget(_ request: CommandArgumentEnvelope) throws -> DrawPathTarget {
    ...
    func decodeDrawBezierTarget(_ request: CommandArgumentEnvelope) throws -> DrawBezierTarget {
