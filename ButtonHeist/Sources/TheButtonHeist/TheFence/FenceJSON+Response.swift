...
struct PublicResponseModel: Encodable {
    ...
    func encode(to encoder: Encoder) throws {
        ...
        case .announcements(let payload):
            try PublicAnnouncementsResponse(payload: payload).encode(to: encoder)
...
struct PublicAnnouncementsResponse: Encodable {
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(payload.announcements, forKey: .announcements)
        try container.encode(payload.notifications, forKey: .notifications)
        try container.encode(payload.captureState, forKey: .captureState)
    }
}
