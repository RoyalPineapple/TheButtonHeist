...
/// representation.
///
/// TheBurglar builds this by instantiating the parser's generic fold with constructors that retain
...
indirect enum CapturedNode {

    // MARK: - Nested Types

    case element(AccessibilityElement, traversalIndex: Int, source: NSObject)
    case container(AccessibilityContainer, children: [CapturedNode], source: NSObject)
