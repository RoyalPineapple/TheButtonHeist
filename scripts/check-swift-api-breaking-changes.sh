...
INTENTIONAL_BREAKAGES=(
    ...
    "enumelement AccessibilityPredicate.State.screen has been added as a new enum case"
    "enumelement AccessibilityPredicateContract.PredicateWireType.screen has been added as a new enum case"
    "enumelement AccessibilityPredicateContract.StateWireType.screen has been added as a new enum case"
    "enumelement AccessibilityPredicateContract.State.screen has been added as a new enum case"
    "enumelement StatePredicateExpr.screen has been added as a new enum case"
