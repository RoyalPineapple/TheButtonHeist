...
- [Detecting a crash](#detecting-a-crash) — MCP disconnection signals
...
How to interpret ButtonHeist MCP tool responses — and how to use them to drive smart, varied testing.
