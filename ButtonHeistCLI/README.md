...
Command-line tool for inspecting and interacting with iOS apps running InsideMan. List devices, watch the UI hierarchy live, tap buttons, swipe lists, type text, capture screenshots — all from the terminal.
