...
> **Platform:** macOS 14.0+
> **Role:** Exposes Button Heist as 21 typed MCP tools for AI agents
...
2. **Tool-to-command routing** for both direct (20) and grouped (1) tools
...
| `ToolDefinitions.swift` | 21 tool schemas with `expectProperty` shared across action tools |
...
flowchart TD
    ...
    Switch -->|"20 direct tools"| Direct["request['command'] = toolName"]
