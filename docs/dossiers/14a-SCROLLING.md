...
Jumps directly to a known element's recorded scroll position. This command is for elements already discovered by `get_interface --full`, previous scrolling, or action deltas.
