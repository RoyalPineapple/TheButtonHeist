...
- [transport-control-plane.md](transport-control-plane.md) — off-main transport admission, the bounded MainActor handoff, main-thread probes, and failure taxonomy
