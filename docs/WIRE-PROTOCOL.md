...
All messages are JSON objects terminated by a newline (`\n`). Version 6.7 uses explicit envelopes with a `type` discriminator and optional `payload`, rather than relying on Swift enum synthesis.
...
```json
{"protocolVersion":"6.7","requestId":"abc-123","type":"activate","payload":{"identifier":"loginButton"}}
```

**Server → Client** (`ResponseEnvelope`):
```json
{"protocolVersion":"6.7","requestId":"abc-123","type":"actionResult","payload":{"success":true,"method":"syntheticTap"}}
```
...
```json
{"protocolVersion":"6.7","type":"clientHello"}
```
...
```json
{"protocolVersion":"6.7","type":"authenticate","payload":{"token":"your-secret-token"}}
```

**With driver identity:**
```json
{"protocolVersion":"6.7","type":"authenticate","payload":{"token":"your-secret-token","driverId":"agent-1"}}
```
...
```json
{"protocolVersion":"6.7","type":"requestInterface"}
```
...
```json
{"protocolVersion":"6.7","type":"subscribe"}
```
...
```json
{"protocolVersion":"6.7","type":"unsubscribe"}
```
...
**By identifier:**
```json
{"protocolVersion":"6.7","type":"activate","payload":{"identifier":"loginButton"}}
```

**By traversal index:**
```json
{"protocolVersion":"6.7","type":"activate","payload":{"order":5}}
```
...
**At coordinates:**
```json
{"protocolVersion":"6.7","type":"touchTap","payload":{"pointX":196.5,"pointY":659.0}}
```

**On element by identifier:**
```json
{"protocolVersion":"6.7","type":"touchTap","payload":{"elementTarget":{"identifier":"submitButton"}}}
```
...
```json
{"protocolVersion":"6.7","type":"touchLongPress","payload":{"pointX":100,"pointY":200,"duration":1.0}}
```

**On element (default 0.5s):**
```json
{"protocolVersion":"6.7","type":"touchLongPress","payload":{"elementTarget":{"identifier":"myButton"},"duration":0.5}}
```
...
```json
{"protocolVersion":"6.7","type":"touchSwipe","payload":{"startX":200,"startY":400,"endX":200,"endY":100,"duration":0.15}}
```

**From element in direction:**
```json
{"protocolVersion":"6.7","type":"touchSwipe","payload":{"elementTarget":{"identifier":"list"},"direction":"up","distance":300}}
```
...
**With explicit coordinates:**
```json
{"protocolVersion":"6.7","type":"touchDrag","payload":{"startX":100,"startY":200,"endX":300,"endY":200,"duration":0.5}}
```

**From element:**
```json
{"protocolVersion":"6.7","type":"touchDrag","payload":{"elementTarget":{"identifier":"slider"},"endX":300,"endY":200}}
```
...
```json
{"protocolVersion":"6.7","type":"touchPinch","payload":{"centerX":200,"centerY":300,"scale":2.0,"spread":100,"duration":0.5}}
```

**On element:**
```json
{"protocolVersion":"6.7","type":"touchPinch","payload":{"elementTarget":{"identifier":"mapView"},"scale":0.5}}
```
...
```json
{"protocolVersion":"6.7","type":"touchRotate","payload":{"centerX":200,"centerY":300,"angle":1.57,"radius":100,"duration":0.5}}
```
...
```json
{"protocolVersion":"6.7","type":"touchTwoFingerTap","payload":{"centerX":200,"centerY":300,"spread":40}}
```
...
```json
{"protocolVersion":"6.7","type":"touchDrawPath","payload":{"points":[{"x":100,"y":400},{"x":200,"y":300},{"x":300,"y":400}],"duration":1.0}}
```

**With velocity:**
```json
{"protocolVersion":"6.7","type":"touchDrawPath","payload":{"points":[{"x":100,"y":400},{"x":200,"y":300},{"x":300,"y":400}],"velocity":500}}
```
...
```json
{"protocolVersion":"6.7","type":"touchDrawBezier","payload":{"startX":100,"startY":400,"segments":[{"cp1X":100,"cp1Y":200,"cp2X":300,"cp2Y":200,"endX":300,"endY":400}],"duration":1.0}}
```

**With samples and velocity:**
```json
{"protocolVersion":"6.7","type":"touchDrawBezier","payload":{"startX":100,"startY":400,"segments":[{"cp1X":100,"cp1Y":200,"cp2X":300,"cp2Y":200,"endX":300,"endY":400}],"samplesPerSegment":40,"velocity":300}}
```
...
**By identifier:**
```json
{"protocolVersion":"6.7","type":"increment","payload":{"identifier":"volumeSlider"}}
```

**By traversal index:**
```json
{"protocolVersion":"6.7","type":"increment","payload":{"order":8}}
```
...
**By identifier:**
```json
{"protocolVersion":"6.7","type":"decrement","payload":{"identifier":"volumeSlider"}}
```
...
```json
{"protocolVersion":"6.7","type":"performCustomAction","payload":{"elementTarget":{"identifier":"myCell"},"actionName":"Delete"}}
```
...
```json
{"protocolVersion":"6.7","type":"typeText","payload":{"text":"Hello","elementTarget":{"identifier":"nameField"}}}
```

**Delete 3 characters:**
```json
{"protocolVersion":"6.7","type":"typeText","payload":{"deleteCount":3,"elementTarget":{"identifier":"nameField"}}}
```

**Delete then retype (correction):**
```json
{"protocolVersion":"6.7","type":"typeText","payload":{"deleteCount":4,"text":"orld","elementTarget":{"identifier":"nameField"}}}
```

**Clear existing text then type new text:**
```json
{"protocolVersion":"6.7","type":"typeText","payload":{"clearFirst":true,"text":"replacement","elementTarget":{"identifier":"nameField"}}}
```
...
```json
{"protocolVersion":"6.7","type":"requestScreen"}
```
...
```json
{"protocolVersion":"6.7","type":"startRecording","payload":{"fps":8,"scale":0.5,"inactivityTimeout":5.0,"maxDuration":60.0}}
```
...
```json
{"protocolVersion":"6.7","type":"stopRecording"}
```
...
**By identifier:**
```json
{"protocolVersion":"6.7","type":"scroll","payload":{"elementTarget":{"identifier":"buttonheist.longList.item-5"},"direction":"up"}}
```

**By traversal index:**
```json
{"protocolVersion":"6.7","type":"scroll","payload":{"elementTarget":{"order":10},"direction":"down"}}
```
...
**By identifier:**
```json
{"protocolVersion":"6.7","type":"scrollToEdge","payload":{"elementTarget":{"identifier":"buttonheist.longList.item-0"},"edge":"bottom"}}
```
...
```json
{"protocolVersion":"6.7","type":"editAction","payload":{"action":"copy"}}
```
...
```json
{"protocolVersion":"6.7","type":"setPasteboard","payload":{"text":"clipboard content"}}
```
...
```json
{"protocolVersion":"6.7","type":"getPasteboard"}
```
...
```json
{"protocolVersion":"6.7","type":"resignFirstResponder"}
```
...
```json
{"protocolVersion":"6.7","type":"waitForIdle","payload":{"timeout":5.0}}
```
...
```json
{"protocolVersion":"6.7","type":"status"}
```
...
```json
{"protocolVersion":"6.7","type":"watch","payload":{"token":""}}
```
...
```json
{"protocolVersion":"6.7","requestId":null,"type":"serverHello"}
```
...
```json
{"protocolVersion":"6.7","requestId":null,"type":"protocolMismatch","payload":{"expectedProtocolVersion":"6.1","receivedProtocolVersion":"5.0"}}
```
...
```json
{"protocolVersion":"6.7","requestId":null,"type":"authRequired"}
```
...
```json
{"protocolVersion":"6.7","type":"authFailed","payload":"Invalid token"}
```
...
```json
{"protocolVersion":"6.7","type":"authApproved","payload":{"token":"auto-generated-uuid-token"}}
```
...
```json
{"protocolVersion":"6.7","type":"sessionLocked","payload":{"message":"Session is locked by another driver","activeConnections":1}}
```
...
```json
{"protocolVersion":"6.7","type":"info","payload":{
  "protocolVersion":"6.7",
  "appName":"MyApp",
...
```json
{"protocolVersion":"6.7","type":"status","payload":{
  "identity":{
    "appName":"MyApp",
    "bundleIdentifier":"com.example.myapp",
    "appBuild":"42",
...
```json
{"protocolVersion":"6.7","type":"interface","payload":{
...
```json
{"protocolVersion":"6.7","type":"actionResult","payload":{
  "success":true,
  "method":"syntheticTap",
  "message":null
}}
...
```json
{"protocolVersion":"6.7","type":"screen","payload":{
  "pngData":"iVBORw0KGgo...",
  "width":393.0,
  "height":852.0,
  "timestamp":"2026-02-03T10:30:45.123Z"
...
```json
{"protocolVersion":"6.7","type":"recordingStarted"}
```
...
```json
{"protocolVersion":"6.7","type":"recordingStopped"}
```
...
```json
{"protocolVersion":"6.7","type":"recording","payload":{
...
```json
{"protocolVersion":"6.7","type":"recordingError","payload":"AVAssetWriter failed to start"}
```
...
```json
{"protocolVersion":"6.7","type":"error","payload":"Root view not available"}
```
...
| Field | Type | Description |
|-------|------|-------------|
| `protocolVersion` | `String` | Protocol version (currently `"6.7"`) |
...
Checks whether any entry in `interfaceDelta.updated` matches the provided fields. All fields are optional — provide more to tighten the check, fewer to loosen it.
...
When both `oldValue` and `newValue` are provided, they must match the same `PropertyChange` entry.

Examples:
```json
{"expect": {"elementUpdated": {"newValue": "5"}}}
{"expect": {"elementUpdated": {"heistId": "counter", "property": "value", "newValue": "5"}}}
{"expect": {"elementUpdated": {"oldValue": "3", "newValue": "5"}}}
{"expect": {"elementUpdated": {}}}
```
...
{"protocolVersion":"6.7","type":"interface","payload":{"timestamp":"2026-02-03T14:08:14.123Z","elements":[...],"tree":[...]}}

# Client requests screen capture
{"protocolVersion":"6.7","type":"requestScreen"}

# Server responds with screen capture
{"protocolVersion":"6.7","type":"screen","payload":{"pngData":"iVBORw0KGgo...","width":393.0,"height":852.0,"timestamp":"2026-02-03T14:08:14.200Z"}}

# Client activates a button
{"protocolVersion":"6.7","type":"activate","payload":{"identifier":"loginButton"}}

# Server confirms action
{"protocolVersion":"6.7","type":"actionResult","payload":{"success":true,"method":"syntheticTap","message":null}}

# Client increments a slider
{"protocolVersion":"6.7","type":"increment","payload":{"identifier":"volumeSlider"}}

# Server confirms
{"protocolVersion":"6.7","type":"actionResult","payload":{"success":true,"method":"increment","message":null}}

# Client performs custom action
{"protocolVersion":"6.7","type":"performCustomAction","payload":{"elementTarget":{"identifier":"messageCell"},"actionName":"Delete"}}

# Server confirms
{"protocolVersion":"6.7","type":"actionResult","payload":{"success":true,"method":"customAction","message":null}}

# Client types text into a field
{"protocolVersion":"6.7","type":"typeText","payload":{"text":"Hello World","elementTarget":{"identifier":"nameField"}}}

# Server confirms with current field value
{"protocolVersion":"6.7","type":"actionResult","payload":{"success":true,"method":"typeText","value":"Hello World"}}

# Client corrects a typo (delete 5 chars, retype)
{"protocolVersion":"6.7","type":"typeText","payload":{"deleteCount":5,"text":"World","elementTarget":{"identifier":"nameField"}}}

# Server confirms correction
{"protocolVersion":"6.7","type":"actionResult","payload":{"success":true,"method":"typeText","value":"Hello World"}}

# Client starts recording
{"protocolVersion":"6.7","type":"startRecording","payload":{"fps":8}}
...
{"protocolVersion":"6.7","type":"activate","payload":{"identifier":"loginButton"}}
{"protocolVersion":"6.7","type":"actionResult","payload":{"success":true,"method":"syntheticTap"}}
...
{"protocolVersion":"6.7","type":"recording","payload":{"videoData":"AAAAIGZ0eXBpc29t...","width":390,"height":844,"duration":5.2,"frameCount":42,"fps":8,"startTime":"2026-02-24T10:30:00.000Z","endTime":"2026-02-24T10:30:05.200Z","stopReason":"manual"}}
...
{"protocolVersion":"6.7","type":"interface","payload":{"timestamp":"2026-02-03T14:08:15.500Z","elements":[...],"tree":[...]}}
{"protocolVersion":"6.7","type":"screen","payload":{"pngData":"...","width":393.0,"height":852.0,"timestamp":"2026-02-03T14:08:15.550Z"}}
```
